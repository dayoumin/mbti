...
export const dogBreedData: SubjectData = {
    ...
    "resultLabels": [
        ...
        },
        {
            ...
            "condition": { "grooming": "high", "training": "high", "energy": "medium" },
            "mood": "cool",
            "color": "bg-purple-100",
        ...
        },
        {
            ...
            "emoji": "🐕",
            "desc": "온순하고 조용한 실내견",
            "condition": { "size": "low", "energy": "low", "training": "low" },
            "mood": "cool",
            "color": "bg-gray-100",
        ...
        },
        {
            ...
            "emoji": "🐕",
            "desc": "짧은 다리에 넘치는 에너지",
            "condition": { "size": "medium", "energy": "high", "training": "medium" },
            "mood": "excited",
            "color": "bg-amber-200",
        ...
        },
        {
            ...
            "emoji": "🐕",
            "desc": "느긋하고 조용한 도시견",
            "condition": { "size": "low", "energy": "low", "grooming": "low" },
            "mood": "cool",
            "color": "bg-slate-100",
        ...
        },
        {
            ...
            "emoji": "🐕",
            "desc": "호기심 많은 탐험가",
            "condition": { "size": "medium", "energy": "high", "independence": "high" },
            "mood": "excited",
            "color": "bg-amber-100",
        ...
        },
        {
            ...
            "emoji": "🐕",
            "desc": "독립적이고 깔끔한 일본견",
            "condition": { "size": "medium", "energy": "medium", "independence": "high" },
            "mood": "cool",
            "color": "bg-red-100",
        ...
        },
        {
            ...
            "condition": { "size": "medium", "energy": "high", "training": "high" },
            "mood": "excited",
            "color": "bg-blue-100",
        ...
        },
        {
            ...
            "emoji": "🐕",
            "desc": "작지만 용감한 테리어",
            "condition": { "size": "low", "grooming": "high", "independence": "medium" },
            "mood": "excited",
            "color": "bg-blue-100",
