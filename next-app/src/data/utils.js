...
import { CHEMI_CONSTANTS } from './constants';

export function getScoreLevel(score, maxScore) {
...
export function matchResultLabel(scores, dimensions, resultLabels, dimCounts) {
