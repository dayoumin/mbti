    ...
    tasks: [
      {
        ...
        status: 'planned',
        priority: 'high',
        description: 'URL에서 utm_source, utm_medium, utm_campaign 추출',
        dependencies: [],
      },
      {
        id: 'utm-storage',
        ...
        status: 'planned',
        priority: 'high',
        description: '첫 방문 시 UTM을 세션에 저장, 이벤트에 포함',
      ...
      },
      {
        ...
        status: 'planned',
        priority: 'medium',
        description: 'document.referrer로 유입 사이트 추적',
        dependencies: [],
      },
      {
        id: 'share-utm-gen',
        ...
        status: 'planned',
        priority: 'high',
        description: '공유 링크에 UTM 자동 추가 (source=share, medium=kakao)',
        dependencies: ['utm-parser'],
      },
    ],
  },
    ...
    tasks: [
      {
        ...
        status: 'planned',
        priority: 'high',
        description: '세션 ID 생성, 세션 시작/종료 시간',
        dependencies: [],
      },
      {
        id: 'funnel-events',
        ...
        status: 'planned',
        priority: 'high',
        description: '방문→테스트시작→완료→공유→재방문 퍼널',
