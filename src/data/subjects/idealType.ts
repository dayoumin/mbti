// idealType 테스트 데이터
// 생성일: 2025-12-11
// 수정일: 2025-12-26 - 중간 점수 옵션 추가, 결과 10개로 확장

export const IDEALTYPE_DATA = {
	"title": "연애 이상형 테스트",
	...
	"questions": [
		...
		},
		{
			...
			"a": [
				...
				{ "text": "주 2-3회 정도가 좋아", "score": 3 },
				{ "text": "주 1회면 충분해", "score": 1 }
			]
		},
		{
			"q": "연애를 시작할 때 나는?",
		...
		},
		{
			...
			"a": [
				...
				{ "text": "함께할 땐 밀착, 떨어질 땐 자유", "score": 3 },
	...
	"questions_deep": [
		...
		},
		{
			...
			"a": [
				...
				{ "text": "가벼운 건 같이, 본격적인 건 따로", "score": 3 },
	...
	"resultLabels": [
		{
			...
			"interpretation": "당신은 공감 능력이 뛰어난 교감과 따뜻한 소통을 중요시해요. 서로의 일상을 공유하고, 자주 사랑을 확인하고 싶어하는 타입이에요.",
		...
		},
		{
			...
			"interpretation": "드라마틱한 연애보다 잔잔하고 편안한 관계를 원해요. 오래 함께해도 부담 없는 관계가 비전이 있는이에요.",
		...
		},
		{
			...
			"interpretation": "함께 무언가를 하면서 추억을 쌓는 것을 좋아해요. 같이 움직이고 경험하는 관계가 비전이 있는이에요.",
		...
		},
		{
			"name": "츤데레 연인",
			"emoji": "🐱",
			"desc": "겉은 쿨하지만 속은 따뜻한 상대",
			"condition": {
				"express": "low",
				"commit": "high"
			},
			"matchPoints": [
				"말은 무뚝뚝해도 행동으로 보여주는 사람",
				"쑥스러워하면서도 챙겨주는 사람",
				"진심을 알아채면 더 감동인 사람"
			],
			"interpretation": "화려한 표현보다 진심 어린 행동을 중요시해요. 말보다 행동으로 사랑을 증명하는 상대가 어울려요.",
			"guide": "첫인상이 차가워도 행동을 잘 관찰해보세요. 숨겨진 따뜻함을 발견할 수 있어요.",
			"mood": "cool",
			"color": "bg-slate-100"
		},
		{
			...
			"matchPoints": [
				"집에서 영화 보며 시간 보내는 걸 좋아하는 사람",
				"밖보다 집에서 함께 있는 게 편한 사람",
				"아늑한 분위기를 만들어주는 사람"
			],
			"interpretation": "화려한 외출보다 소소한 일상의 행복을 추구해요. 집에서 함께하는 시간이 가장 편안하고 행복해요.",
			"guide": "밖에서 노는 것보다 집에서 시간 보내는 걸 좋아하는지 확인해보세요.",
			"mood": "happy",
			"color": "bg-amber-100"
		},
		{
...
if (typeof window !== 'undefined') {
  ...
  window.CHEMI_SUBJECTS.idealType = IDEALTYPE_DATA;
}