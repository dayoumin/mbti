    ...
    "resultLabels": [
        {
            ...
            "meta": {
                ...
                "funFacts": {
                    "didYouKnow": [
                        "강아지는 인간의 감정을 읽을 수 있어요. 슬픔, 기쁨을 구분한답니다",
                        "강아지 코의 지문은 사람 지문처럼 모두 달라요",
                        "강아지가 빙글빙글 돌고 눕는 건 야생 시절 풀을 누르던 본능이에요",
                        "강아지는 땀샘이 발바닥에만 있어서 혀로 체온 조절해요"
                    ],
                    "commonMistakes": [
                        "초콜릿은 강아지에게 독이에요! 절대 주면 안돼요",
                        "포도, 건포도도 신장 손상을 일으켜요",
                        "사람 음식 양념은 강아지에게 해로워요",
                        "하루 산책 안 시키면 스트레스로 문제행동이 생겨요"
                    ],
                    "proTips": [
                        "산책 후 발바닥 닦아주면 피부병 예방돼요",
                        "간식은 하루 칼로리의 10% 이내로!",
                        "꾸중할 땐 현행범일 때만 효과있어요"
                    ],
                    "viralOneLiner": "강아지는 당신의 모든 비밀을 알지만 절대 말 안 해요 🐕"
                }
            }
        },
        {
            ...
            "meta": {
                ...
                "funFacts": {
                    "didYouKnow": [
                        "고양이는 하루 16시간 자요. 인생의 70%가 수면!",
                        "고양이 골골송은 치유 주파수(25-150Hz)라 뼈 회복에 도움돼요",
                        "고양이는 100가지 이상의 소리를 낼 수 있어요",
                        "고양이가 천천히 눈 깜빡이면 '사랑해' 표현이에요"
                    ],
                    "commonMistakes": [
                        "우유는 대부분의 성묘에게 설사를 유발해요",
                        "배를 보여준다고 만지면 안돼요 - 신뢰 표현일 뿐!",
                        "백합과 식물은 고양이에게 치명적이에요",
                        "혼내면 효과 없고 신뢰만 잃어요"
                    ],
                    "proTips": [
                        "화장실은 고양이 수 +1개가 이상적",
                        "수직 공간(캣타워)이 영역 스트레스를 줄여요",
                        "천천히 눈 깜빡여서 애정 표현 해보세요"
                    ],
                    "viralOneLiner": "고양이는 당신을 집사로 고용했을 뿐이에요 🐱"
                }
            }
        },
        {
            ...
            "meta": {
                ...
                "funFacts": {
                    "didYouKnow": [
                        "햄스터 볼주머니는 몸 중간까지 늘어날 수 있어요",
                        "햄스터는 하룻밤에 9km까지 쳇바퀴를 달려요",
                        "토끼는 기쁘면 '빙키'라는 점프를 해요",
                        "기니피그는 행복하면 '팝콘'처럼 통통 뛰어요"
                    ],
                    "commonMistakes": [
                        "햄스터는 야행성! 낮에 깨우면 스트레스받아요",
                        "솜으로 만든 집은 장에 걸릴 수 있어 위험해요",
                        "햄스터 쳇바퀴는 18cm 이상이어야 허리 안 다쳐요",
                        "토끼에게 당근만 주면 안돼요 - 건초가 주식!"
                    ],
                    "proTips": [
                        "햄스터 케이지는 최소 가로 60cm 이상이 좋아요",
                        "토끼는 발바닥에 털이 있어 미끄러운 바닥 피해야 해요",
                        "소동물 온도는 20~25도가 적정해요"
                    ],
                    "viralOneLiner": "햄스터는 뺨에 당신 월급 저축 중 🐹💰"
                }
            }
        },
        {
            ...
            "meta": {
                ...
                "funFacts": {
                    "didYouKnow": [
                        "금붕어 기억력은 3초가 아니라 최대 5개월이에요!",
                        "베타는 주인 얼굴을 기억하고 반응해요",
                        "물고기도 잠을 자요 - 눈을 뜨고 자는 것뿐!",
                        "수족관 보면 혈압이 낮아지고 스트레스가 줄어요"
                    ],
                    "commonMistakes": [
                        "어항에 수돗물 바로 넣으면 염소 때문에 위험해요",
                        "물고기도 과식해요! 5분 내 먹을 양만 주세요",
                        "어항이 작을수록 수질 관리가 어려워요",
                        "베타 수컷끼리는 싸워요 - 합사 금지!"
                    ],
                    "proTips": [
                        "물갈이는 전체가 아닌 1/3씩 교체하세요",
                        "수족관 조명은 8~10시간이 적당해요",
                        "여과기 청소 시 수족관 물로 씻어야 박테리아가 살아요"
                    ],
                    "viralOneLiner": "금붕어 기억력 3초? 완전 거짓말이에요 🐠"
                }
            }
        },
        {
            ...
            "meta": {
                ...
                "funFacts": {
                    "didYouKnow": [
                        "앵무새는 2~5세 아이 수준의 지능을 가졌어요",
                        "큰 앵무새는 50년 이상 살 수 있어서 유언장에 쓰기도 해요",
                        "카나리아 수컷만 노래해요 - 구애 행동이에요",
                        "새는 공룡의 후손이에요! 깃털 달린 공룡"
                    ],
                    "commonMistakes": [
                        "아보카도는 새에게 치명적인 독이에요",
                        "테플론 코팅 팬 과열 시 나오는 가스도 위험해요",
                        "케이지 위치가 창가 직사광선이면 안돼요",
                        "앵무새 깃털 뽑기는 스트레스 신호예요"
                    ],
                    "proTips": [
                        "매일 30분 이상 케이지 밖 교감 시간을 가지세요",
                        "새도 일광욕이 필요해요 - 비타민D 합성",
                        "앵무새 훈련은 간식 보상이 효과적이에요"
                    ],
                    "viralOneLiner": "앵무새에게 비밀 말하면... 진짜 말해요 🦜"
                }
            }
        },
        {
            ...
            "meta": {
                ...
                "funFacts": {
                    "didYouKnow": [
                        "레오파드 게코는 눈을 혀로 핥아 청소해요",
                        "볼파이톤은 위협받으면 공처럼 말아요 - 이름 유래!",
                        "거북이는 등껍질에도 신경이 있어서 만지면 느껴요",
                        "도마뱀 일부는 꼬리가 잘려도 다시 자라요"
                    ],
                    "commonMistakes": [
                        "파충류는 체온 조절 못해서 온도 구배가 필수예요",
                        "거북이는 양상추만 먹으면 영양실조 와요",
                        "뱀은 먹이 먹은 후 48시간은 만지면 안돼요",
                        "파충류도 스트레스받아요 - 과도한 핸들링 주의"
                    ],
                    "proTips": [
                        "핫스팟(32-35도)과 쿨존(25도)을 모두 만들어주세요",
                        "탈피 시 습도를 높여주면 깔끔하게 벗어요",
                        "먹이 곤충에게도 영양제 급여(거트로딩)가 중요해요"
                    ],
                    "viralOneLiner": "파충류는 냉혈하지만 당신 마음은 녹여요 🦎❤️"
                }
            }
        }
    ]
