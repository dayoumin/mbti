...
export const BADGES: Badge[] = [
  ...
  },
  {
    id: 'poll-addict',
    name: '투표 중독자',
    description: '50개 이상 투표 참여',
    emoji: '🎯',
    category: 'poll',
    rarity: 'rare',
    condition: { type: 'count', value: 50, description: '투표 50개 참여' },
    points: 100,
  },
  {
    id: 'minority-first',
    name: '첫 소수 의견',
    description: '소수 의견을 처음 선택',
    emoji: '🦄',
    category: 'poll',
    rarity: 'common',
    condition: { type: 'count', target: 'minority', value: 1, description: '소수 의견 1회 선택' },
    points: 15,
  },
  {
    id: 'minority-5',
    name: '독특한 시선',
    description: '소수 의견 5회 선택',
    emoji: '💎',
    category: 'poll',
    rarity: 'rare',
    condition: { type: 'count', target: 'minority', value: 5, description: '소수 의견 5회 선택' },
    points: 50,
  },
  {
    id: 'minority-voice',
    name: '소신파',
    description: '투표의 절반 이상이 소수 의견',
    emoji: '🎭',
    category: 'poll',
    rarity: 'epic',
    condition: { type: 'special', description: '10회 이상 투표 중 50% 이상 소수 의견' },
    points: 100,
  },
  {
    id: 'cat-poll-lover',
    name: '냥집사 투표왕',
    description: '고양이 투표 10개 참여',
    emoji: '🐱',
    category: 'poll',
    rarity: 'rare',
    condition: { type: 'count', target: 'cat', value: 10, description: '고양이 투표 10개 참여' },
    points: 50,
  },
  {
    id: 'dog-poll-lover',
    name: '댕댕이 투표왕',
    description: '강아지 투표 10개 참여',
    emoji: '🐕',
    category: 'poll',
    rarity: 'rare',
    condition: { type: 'count', target: 'dog', value: 10, description: '강아지 투표 10개 참여' },
    points: 50,
  },
  {
    id: 'love-poll-lover',
    name: '연애 고수',
    description: '연애 투표 10개 참여',
    emoji: '💕',
    category: 'poll',
    rarity: 'rare',
    condition: { type: 'count', target: 'love', value: 10, description: '연애 투표 10개 참여' },
    points: 50,
  },
