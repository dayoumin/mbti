...
export const CAT_SCENARIO_QUIZZES: ScenarioQuiz[] = [
  {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id: 'c', text: '무시하고 짐 먼저 정리해요', points: 3, feedback: '고양이가 섭섭해할 수 있어요...' },
      ...
      },
      {
        ...
        options: [
          ...
          { id: 'b', text: '고양이 냄새가 묻은 담요를 가구에 놓는다', points: 10, feedback: '완벽해요! 익숙한 냄새로 안정감을 줘요' },
          { id: 'c', text: '간식으로 가구 근처로 유인한다', points: 8, feedback: '좋은 방법이에요! 긍정적 연관을 만들어요' },
      ...
      },
      {
        ...
        options: [
          ...
          { id: 'b', text: '사냥 본능 + 못 잡는 좌절감', points: 10, feedback: '정확해요! 채터링은 사냥 본능이에요' },
      ...
      },
      {
        ...
        options: [
          ...
          { id: 'c', text: '화장실을 더 작은 걸로 바꾼다', points: 3, feedback: '오히려 답답할 수 있어요' },
      ...
      },
      {
        ...
        options: [
          ...
          { id: 'c', text: '"낯가림해서 안 나올 수 있어요"라고 미리 말한다', points: 10, feedback: '완벽! 고양이의 성격을 존중하는 대응이에요' },
          { id: 'd', text: '간식으로 유인한다', points: 4, feedback: '고양이가 원하면 나오는 거예요' },
        ],
      },
      {
        id: 'q8',
        situation: '고양이가 키우던 화분 흙을 파헤쳤어요.',
        question: '어떻게 대처하시나요?',
        options: [
      ...
      },
      {
        ...
        options: [
          { id: 'a', text: '새 집에 새 용품을 다 새로 산다', points: 3, feedback: '익숙한 냄새가 중요해요!' },
          { id: 'b', text: '기존 용품을 가져가고 페로몬 제품 준비', points: 10, feedback: '완벽! 익숙한 물건과 페로몬이 안정에 도움돼요' },
    ...
    results: [
      ...
      },
      {
        ...
        tips: ['고양이 관련 커뮤니티에 가입해보세요', '기본적인 고양이 습성을 공부해보세요'],
      },
      {
        minScore: 0,
        maxScore: 29,
