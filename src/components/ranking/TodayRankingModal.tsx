...
import PollRankingTab from './PollRankingTab';
import ResultRankingTab from './ResultRankingTab';
...
export default function TodayRankingModal({
  ...
  // 커스텀 훅 사용
  const { pollRankings, resultRankings, loading, totalParticipants } = useRankingData(isOpen);
