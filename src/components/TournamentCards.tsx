    ...
    <div className={`bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 rounded-2xl p-5 border border-amber-100/50 ${className}`}>
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-base font-bold text-primary">이상형 월드컵</h3>
      ...
      <div className="grid grid-cols-2 gap-2.5">
        {ACTIVE_TOURNAMENTS.slice(0, 4).map((tournament) => (
          <button
            ...
            className={`p-3.5 ${tournament.themeColor} rounded-xl border border-slate-200/50 hover:shadow-md transition-all text-left group`}
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <ChevronRight className="w-4 h-4 text-subtle group-hover:translate-x-0.5 transition-transform" />
            </div>
          </button>
        ))}
      </div>
