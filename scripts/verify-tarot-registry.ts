...
import { ALL_KNOWLEDGE_QUIZZES, ALL_SCENARIO_QUIZZES, TAROT_QUIZZES } from '../src/data/content/quizzes';
import { VS_POLLS, CHOICE_POLLS } from '../src/data/content/polls';
import { TAROT_VS_POLLS, TAROT_CHOICE_POLLS } from '../src/data/content/polls/tarot-polls';
...
// ID 검증
const tarotQuizIds = new Set<string>();
...
// ID 및 필수 필드 검증
const tarotVsIds = new Set<string>();
...
// ID 및 필수 필드 검증
const tarotChoiceIds = new Set<string>();
